...
// isBlockValid makes sure block is valid by checking index, comparing the hash of the previous block, and comparing the hash of the new block
...
// pickWinner creates a lottery pool of validators and chooses the validator who gets to
// forge a block to the blockchain by random selecting from the pool, weighted by amount of tokens staked
func pickWinner() {
